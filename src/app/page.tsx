   ...
   <Nav/>
    <section className="flex min-h-screen flex-col items-center justify-between p-8 mb-15 mt-18 border-b-2 border-blue-500/25">
      <div className=" w-full max-w-5xl items-center justify-around font-mono text-sm lg:flex gap-8">
          <div className="block ">
            <h1 className="text-4xl font-bold ">Hello,I'm<br></br>Gloire Nissi OYERE</h1>
            <p className="mb-8 ml-4">Full Stack Developer</p>

            <p>Lorem ipsum dolor sit amet consecteturh hurr </p>
            <p>Lorem ipsum dolor sit amet consectetur fgsftd </p>

            <div className="flex flex-row items-center  mt-7 ml-10 space-x-2">
            <button className="bg-blue-500/45 rounded-lg p-2 hover:shadow-md hover:shadow-blue-500/75">Download CV</button>
            <button className="bg-blue-500/45 rounded-lg p-2  hover:shadow-md hover:shadow-blue-500/75">Explore</button>
            </div>
          </div>
     ...
     <div className="flex flex-row justify-around gap-4 items-center mt-20 mb-20">
      <div className="bg-blue-500/45 rounded-md p-5 shadow-lg shadow-blue-500">
      <Image
